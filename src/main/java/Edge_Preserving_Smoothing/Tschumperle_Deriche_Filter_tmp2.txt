...
import imagingbook.pub.edgepreservingfilters.TschumperleDericheFilter_tmp2.Parameters;
import imagingbook.pub.edgepreservingfilters.TschumperleDericheFilter_tmp2;
...
public class Tschumperle_Deriche_Filter_tmp2 implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		if (!getParameters())
			return;
		if (isColor) {
			new TschumperleDericheFilter_tmp2((ColorProcessor)ip, params).apply();
		}
		else
