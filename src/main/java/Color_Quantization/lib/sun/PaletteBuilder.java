package Color_Quantization.lib.sun;
...
// http://alvinalexander.com/java/jwarehouse/openjdk-8/jdk/src/share/classes/com/sun/imageio/plugins/common/PaletteBuilder.java.shtml
...
public class PaletteBuilder {
     ...
     * <code>src using IndexColorModel.
     *
     ...
     * and <code>canCreatePalette returns false.
     *
    ...
    public static RenderedImage createIndexedImage(RenderedImage src, int colors) {
        PaletteBuilder pb = new PaletteBuilder(src, colors);
        pb.buildPalette();
        return pb.getIndexedImage();
    }
     ...
     * indexed.
     *
     * @return <code>true if the PaletteBuilder
    ...
    public PaletteBuilder(RenderedImage src) {
        this(src, 256);
    }

    public PaletteBuilder(RenderedImage src, int size) {
        this.src = src;
