...
import imagingbook.pub.color.quantize.MedianCutQuantizerOld;


public class Median_Cut_Quantization_Old implements PlugInFilter {
	...
	public void run(ImageProcessor ip) {
		...
		ColorQuantizerOld q = new MedianCutQuantizerOld(cp, NCOLORS);
