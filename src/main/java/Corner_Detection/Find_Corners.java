...
import imagingbook.lib.color.BasicAwtColor;
...
import imagingbook.pub.corners.GradientCornerDetector.Parameters;
import imagingbook.pub.corners.HarrisCornerDetector;
import imagingbook.pub.corners.MopsCornerDetector;
import imagingbook.pub.corners.ShiTomasiCornerDetector;
...
public class Find_Corners implements PlugInFilter {
	...
	private static DetectorType DetType = DetectorType.Harris;
	...
	private boolean showDialog() {
		...
		gd.addEnumChoice("Detector type", DetType);
		...
		DetType = gd.getNextEnumChoice(DetectorType.class);
